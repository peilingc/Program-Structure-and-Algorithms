...
public class Timer {
     ...
     * run the given functions n times while being timed, i.e. once per "lap", 
     ...
     * @param preFunction  a function which pre-processes a T value and precedes the call of function, but is not timed (may be null).
     * @param postFunction a function which consumes a U and succeeds the call of function, but is not timed (may be null).
     * @return the average milliseconds per repetition.
     * 
     * Pre-function allows you to reinitialize the array (algorithms tend to run quicker when elements are already sorted). 
     * Post-function can be used to double-check that the array really is sorted. 
     * You don't have to use these but if you do reinitialize each time, 
     * the code is likely to be more difficult to write if you don't use the preFunction.
     */
    public <T, U> double repeat(int n, Supplier<T> supplier, Function<T, U> function, UnaryOperator<T> preFunction, Consumer<U> postFunction) {
        ...
        // pause and compute mean lap time
        pause();
    ...
    private static long getClock() {
    	...
    	//return TimeUnit.MILLISECONDS.toNanos(temp);
    }
